    ...
    <div className="py-12 px-4">
      <div className="container max-w-4xl mx-auto">
        ...
        <div className="mb-12 text-center">
          <div className="inline-block w-full h-1 rounded-full bg-gradient-to-r from-brand-blue via-brand-red to-brand-green max-w-xs mb-6" />
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About the Programme</h1>
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            The National AI and Emerging Technologies Scholars Initiative is a U.S. Embassy Nigeria flagship programme designed to bridge the gap between Nigeria&apos;s exceptional student talent and world-class U.S. university education.
          </p>
        </div>
